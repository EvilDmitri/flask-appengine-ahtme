...
app.add_url_rule('/antares', 'antares', view_func=Collectives.Antares.as_view('antares'))
app.add_url_rule('/arlekin', 'arlekin', view_func=Collectives.Arlekin.as_view('arlekin'))
